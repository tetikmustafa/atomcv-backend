...
#
# The sign-in is three requests and one email, and doing it by hand on
...
case "$CODE" in
    202) echo "202 -- ve adresin hesabi olsun olmasin hep 202 ";;
...
# Mail scanners follow links, and a one-shot token spent by a
...
# Expired, already used, wrong verifier and never existed are one
