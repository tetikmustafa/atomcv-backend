...
**Taşındı → [`spec/18-appendix-d.md`](spec/18-appendix-d.md).**

Spec'in gövdesi buraya 75 kez atıf yapıyor ve bu dosya `sync-spec.sh`'ın
kopyaladığı ağacın dışında: frontend'deki spec kopyasında her atıf boşa
düşüyordu. İkinci bir kopya bırakmak, ikisinin ayrışmasını beklemek olurdu.
