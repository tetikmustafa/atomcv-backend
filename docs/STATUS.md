...
**Son güncelleme:** 2026-08-24 · Kuyruk indi (2.6/1); **`B-037` açık**
...
| 2.5 Faz B (skorlama) | ✅ |
| 2.6 kuyruk ve SSE | 🔨 kuyruk + worker indi; `generations`, 202 ve SSE kaldı |
| 2.7 kota ve maliyet | ⬜ |
...
§ 19.2, § 27.1-27.3, § 28.4, § 30.2-30.5, § 53.3, § 54.2, § 10.1, EK D.6.1, XI-A.5-6 güncellendi — **`sync-spec.sh` Aşama 2
kapanışında topluca çalıştırılacak** (karar: 2026-08-21).

**Aşama 1:** 9/9 ✅, `F-001`…`F-007` kapandı · **Test:** 525 birim · 185 entegrasyon · 44 latex
