...
**2026-08-27** · **3.6 · 1/3 — anonim oturum indi** · frontend'de açık: **`B-044`**–**`B-052`**, dokuzu da bekliyor
...
| 3.6 anonim mod | 🔄 1/3 — oturum ✅, kalıcı olmayan profil ⬜, kota+yükseltme ⬜ |
...
**`F-001`…`F-016` kapandı, açık `F-nnn` yok.** **Test:** 878 birim · 346 entegrasyon · 48 latex — 0 hata
...
almadı**; ilk birkaçı onu sınırın altına indirir. Backend 3.6 dilim 2'de (kalıcı olmayan profil).
