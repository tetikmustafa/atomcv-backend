...
**2026-08-27** · **3.6 · 4/6 — oturum, profil, kota, işin anonim sahibi** · frontend'de açık: **`B-044`**–**`B-052`**, dokuzu da bekliyor
...
| 3.6 anonim mod | 🔄 4/6 — oturum/profil/kota/iş sahibi ✅, yükleme ⬜, yükseltme ⬜ |
...
**`F-001`…`F-016` kapandı, açık `F-nnn` yok.** **Test:** 880 birim · 366 entegrasyon · 48 latex — 0 hata
...
almadı**; ilk birkaçı onu sınırın altına indirir. Backend 3.6 dilim 5'te (anonim yükleme).
