...
interface GenerationJpaRepository extends JpaRepository<Generation, UUID> {
     ...
     * hand edit and retires the one it replaced, so twenty edits of one CV is
     * twenty-one rows and one of them is the CV. The rows stay -- nothing is
     * deleted and every one of them can still be downloaded by id -- they are
     * simply not what "my generations" means.
     */
    ...
    /**
     * The page after a cursor, keyset rather than offset.
     *
