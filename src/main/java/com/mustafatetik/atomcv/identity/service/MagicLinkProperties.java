 ...
 *
 * <p>At the frontend, not here, and prefetching is why: the address in the
 ...
 * scanner is a sign-in the person never got. The redemption is the {@code
 * POST} that button makes.
 *
