 ...
 * take the anomaly detector with it, and nothing would say so. Each scheduled
 * component now carries its own {@code @ConditionalOnProperty} and the timer
 * itself is unconditional — a scheduler with nothing scheduled costs one idle
 * thread.
 */
@Configuration
@EnableScheduling
