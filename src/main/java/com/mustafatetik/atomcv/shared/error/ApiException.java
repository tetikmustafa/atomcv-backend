 ...
 * rather than exceptions. This is for the layer above: a request that cannot
 * be served, where the alternative would be threading a Result through every
 * controller signature for a case that always ends the request.
 *
