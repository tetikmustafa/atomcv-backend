 ...
 * place. Bolum 53.5 asks for 99% conformance on Faz A, so this link belongs
 * behind one that enforces a schema rather than in front of it -- a chain
 * naming it first would pay the retry on every generation.
 */
@Component
