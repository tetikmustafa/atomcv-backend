...
class CoverLetterServiceTest {
    ...
    void agoodLetterIsWhatComesBack() {
        ...
        var written = service.write(input(), CoverLetterStyle.DEFAULT, "a-user", null, null);
    ...
    void asecondAttemptThatPassesIsUsed() {
        ...
        assertThat(service.write(input(), CoverLetterStyle.DEFAULT, "a-user", null, null).isErr())
                .isFalse();
    ...
    void thestyleIsAnInstructionAndTheCvIsNot() {
        ...
        service.write(input(), CoverLetterStyle.SHORTER, "a-user", null, null);
    ...
    void thewholeOfTheCvTravelsInsideTheFence() {
        ...
        service.write(input(), CoverLetterStyle.DEFAULT, "a-user", null, null);
